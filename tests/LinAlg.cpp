...
TEST_CASE("Linear Algebra", "[dsp][linalg]")
{
    SECTION("Matrix mult vector")
    {
        ...
        dsp::linalg::Matrix<float, kN> m = {
            ...
            0.3671050259076819,  0.03221069684247624,
            0.48051192620455274, 0.877288993134758,

            0.29311101955536323, 0.4163668941981783,
            0.5987133508019171,  0.6853979608797864,

            0.9613021771529163,  0.9649997209773631,
    ...
    SECTION("Matrix mult vector")
    {
        ...
        dsp::linalg::Matrix<float, kN> m1 = {
            ...
            0.05965172967910248,  0.3662754999849357,
            0.2258265068658456,   0.39373537797612357,

            0.53364789051963,     0.05103040062499764,
            0.008064225605900477, 0.3766549704122426,

            0.6937804176459286,   0.4811429022446442,
        ...
        dsp::linalg::Matrix<float, kN> m2 = {
            ...
            0.72722868657717,    0.5181388010248434,
            0.18017720769473555, 0.872264239292175,

            0.5062309229672677,  0.6859722360078181,
            0.4087377229526331,  0.31669567803917065,

            0.8546789935652717,  0.6052328259522658,
        ...
        dsp::linalg::Matrix<float, kN> expect = {
            ...
            0.7984173297178734, 0.9749096736027327,
            0.8354859284541799, 1.159160943138745,

            0.5248400735652778, 0.6724777262955022,
            0.5027582514549355, 0.7803088851700942,

            1.2000353576396172, 1.1312920089443301,
            0.9370394486096871, 1.507979477974491,
        };
